...
class GridContext private constructor() {
   ...
   private val cells = mutableStateMapOf<Cell, MutableSet<Pair<Int, Int>>>()
    ...
    */
   fun updateOccupation(cell: Cell, occupyAt: MutableSet<Pair<Int, Int>>): Boolean {
      /**
       * Filtering out the previous location.
       */
      val currentOccupation = cells.getOrPut(cell) { mutableSetOf() }
