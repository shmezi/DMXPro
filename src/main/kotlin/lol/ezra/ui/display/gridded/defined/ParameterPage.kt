package lol.ezra.ui.display.gridded.defined
...
import lol.ezra.ui.display.gridded.grid.Cell
...
) : Cell(modifier = Modifier.border(3.dp, Color.Green, RoundedCornerShape(10)), context, width, height, x, y, color = Color.Red) {
